...
****ACTUALLY! you don't need to do any of the following, you can enter it all using the raspi imager tool. fill in username, password, wifi ssid and password, country and locale, click the enable ssh checkbox and finally click the "skip first setup wizard". then you can continue after the ******. or you could do it the oldfashioned manual way described below and feel like a hacker :P
